...
def create_mlp_components(in_channels, out_channels, classifier=False, dim=2, width_multiplier=1):
    '''
    Create a list of layers for MLP.

    Args:
        in_channels (int): The number of input channels.
        out_channels (int or list of int): The number of output channels.
        classifier (bool): Whether the output is for classification.
        dim (int): The dimension of the input.
        width_multiplier (float): The width multiplier for the network.

    Returns:
        layers (list of nn.Module): The list of layers.
...
def create_pointnet_components(blocks, in_channels, with_se=False, normalize=True, eps=0,
    ...
    '''
    Create a list of layers for PointNet.

    Args:
        blocks (list of tuple): The list of blocks.
        in_channels (int): The number of input channels.
        with_se (bool): Whether to use SE layers.
        normalize (bool): Whether to use batch normalization.
        eps (float): The epsilon value for batch normalization.
        width_multiplier (float): The width multiplier for the network.
        voxel_resolution_multiplier (float): The voxel resolution multiplier for the network.

    Returns:
        layers (list of nn.Module): The list of layers.
        in_channels (int): The number of output channels.
        concat_channels (int): The number of concatenated channels.
    '''
...
def create_pointnet2_sa_components(sa_blocks, extra_feature_channels, with_se=False, normalize=True, eps=0,
    ...
    Args:
        sa_blocks (list of tuple): The list of blocks.
        extra_feature_channels (int): The number of extra feature channels.
        with_se (bool): Whether to use SE layers.
        normalize (bool): Whether to use batch normalization.
        eps (float): The epsilon value for batch normalization.
        width_multiplier (float): The width multiplier for the network.
    ...
    Returns:
        sa_layers (list of nn.Module): The list of layers.
        sa_in_channels (list of int): The number of input channels.
        in_channels (int): The number of output channels.
...
def create_pointnet2_fp_modules(fp_blocks, in_channels, sa_in_channels, with_se=False, normalize=True, eps=0,
    ...
    Args:
        fp_blocks (list of tuple): The list of blocks.
        in_channels (int): The number of input channels.
        sa_in_channels (list of int): The number of input channels for each SA layer.
        with_se (bool): Whether to use SE layers.
        normalize (bool): Whether to use batch normalization.
        eps (float): The epsilon value for batch normalization.
        width_multiplier (float): The width multiplier for the network.
    ...
    Returns:
        fp_layers (list of nn.Module): The list of layers.
        in_channels (int): The number of output channels.
    '''
